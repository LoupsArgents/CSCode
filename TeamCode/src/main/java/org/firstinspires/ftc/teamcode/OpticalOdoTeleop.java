...
@TeleOp
public class OpticalOdoTeleop extends LinearOpMode {
    ...
    double lss2Launch = 0.385; //was 0.3925. .385 is about a 42 degree angle, .35 is too steep, .37 was what we started worlds with, then we made it .385, then .37 again
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("X", opticalOdo.getPosition().x);
            telemetry.addData("Y", opticalOdo.getPosition().y);
            telemetry.addData("OdoX", CSYorkDF.newInchesTraveled(strafeStart, strafeOdo.getCurrentPosition()));
            telemetry.addData("OdoY", CSYorkDF.newInchesTraveled(forwardStart, forwardOdo.getCurrentPosition()));
