...
public class CSLocalizationTesting extends LinearOpMode {
    ...
    public double getInchesTraveled(MotorEx encoder, int encoderInitial){ //the version that takes encoderInitial in ticks
        //Math time.
    ...
    public double getInchesTraveled(MotorEx encoder, double encoderInitial){ //the version that takes encoderInitial in inches
    ...
    public void initializeHardware(){
        ...
        strafeOdo = hardwareMap.get(MotorEx.class, "motor0");
        strafeInitialTicks = strafeOdo.getCurrentPosition();
        forwardOdo = hardwareMap.get(MotorEx.class, "motor3");
